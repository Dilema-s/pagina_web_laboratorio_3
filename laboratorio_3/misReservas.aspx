<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="misReservas.aspx.vb" Inherits="laboratorio_3.misReservas" %>
            ...
            <div class="col-md-2">
              ...
              <nav >
                 <ul class="nav text-center">
                       <li ><a href="historialReservas.aspx"><i class="fa fa-list icon" aria-hidden="true"></i>Mi historial de reservas</a></li>
                           ...
                           <table id="tabla" class="table table-striped" style="background-color:white;">
                            ...
                            <asp:Repeater ID="repeater" runat="server" > 
                                <ItemTemplate>
                                    ...
                                    <td> <a href="javascript:$('#exampleModal').modal('show');
                                        $('#id_reserva').val('<%#Container.DataItem("id_reserva")%>');                                     
                                        $('#titulo').val('<%# Container.DataItem("id_item")%>');
                                        $('#label12').html('Esta seguro que desea cancelar la reserva de <%#Container.DataItem("id_item")%> ??')">Cancelar</a></td>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <input style="display:none" type="number" class="modal-title" runat="server" id="id_reserva"/>
                               <input style="display:none" type="text" class="modal-title" runat="server" id="titulo"/>
                            
                          </div>
                          <div class="modal-body">
                           
                           <label id="label12" style="color:inherit;"></label>
