<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="verModificarDvd.aspx.vb" Inherits="laboratorio_3.verModificarDvd" %>
...
<body>
           <div class="container-fluid cabe fondo">
            ...
            <h2 class="text-right titulo">DVD</h2>
            ...
            <div class="col-md-2">
              ...
              <nav >
                 <ul class="nav text-center">
                     ...
                     <li ><a href="dvd.aspx"><i class="fa fa-list icon" aria-hidden="true"></i>Agregar DVD</a></li>
                           ...
                           <table id="tabla" class="table table-striped" style="background-color:white;">
                            ...
                            <asp:Repeater ID="repeater" runat="server" > 
                                <ItemTemplate>
                                    ...
                                    <td><a href="javascript:$('#exampleModal').modal('show');$('#id_libro').val('<%# Container.DataItem("id_dvd")%>');
                                        $('#titulo').val('<%# Container.DataItem("titulo")%>');
                                        $('#diretor').val('<%# Container.DataItem("director")%>');
                                        $('#genero').val('<%# Container.DataItem("id_genero")%>');
                                        $('#estado').val('<%# Container.DataItem("id_estado")%>');
                                        $('#publicado').val('<%# Container.DataItem("publicado")%>');
                                     ...
                                     <td><a href="javascript:$('#baja').modal('show');$('#Text1').val('<%# Container.DataItem("id_dvd")%>');
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                           ...
                           <div class="form-group">
                               <label style="color:inherit;">Director</label>
                               <input type="text" runat="server" id="diretor"/>
                           </div>
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                   <label style="color:inherit;">Publicado por</label>
                                   <input type="text" runat="server" id="publicado"/>
                           </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                   ...
                                   <asp:DropDownList ID="estado1" runat="server"></asp:DropDownList>
                           </div>
