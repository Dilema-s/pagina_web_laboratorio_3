<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dvd.aspx.vb" Inherits="laboratorio_3.dvd" %>
...
<body>
    ...
    <h2 class="text-right titulo">Alta DVD</h2>
    ...
    <div class="col-md-2">
      ...
      <nav >
         <ul class="nav text-center">
              ...
              <li ><a href="verModificarDvd.aspx"><i class="fa fa-list icon" aria-hidden="true"></i>Volver</a></li>
    ...
    <div class="container col-md-offset-1 col-md-7">
          ...
          <div class="form-group">
              <label for="inputAutor" class="col-sm-2">director</label>
            <div class="col-sm-10">
              <input id="director" class="form-control" runat="server" placeholder="Director" type="text"/> 
              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" controltovalidate="director" runat="server" 
                ErrorMessage="Campo vacio" ValidationGroup="grupo1"></asp:RequiredFieldValidator>
            </div>
          </div>
           ...
           <div class="form-group">
            <label for="inputCalle" class="col-sm-2">Publicado por</label>
            <div class="col-sm-10">
               <input id="publicado" class="form-control" runat="server" placeholder="Publicado" type="text"/> 
               
               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" controltovalidate="publicado" runat="server" 
                ErrorMessage="Campo vacio" ValidationGroup="grupo1"></asp:RequiredFieldValidator>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
               <input id="año" class="form-control" runat="server" placeholder="Año de publicación" type="text"/> 
